...
INSERT INTO `user_website` VALUES (2,2,1),(3,6,1);
...
INSERT INTO `users` VALUES (2,'admin','admin@gmail.com',NULL,'$2y$12$krefCzD4dqcefaFy8dugrOHvkB6qfbeeZFyXakIWVPyQ4DWsPjvUS',NULL,NULL,NULL,NULL,'2026-03-06 14:02:54','2026-03-06 14:02:54',3),(6,'abc','abc@gmail.com',NULL,'$2y$12$yfLMApa/JiHVlXqBCM.MKO7JP5iJFrMZbs8fLhAfyDZZSXxCFvL3i',NULL,NULL,NULL,NULL,'2026-03-09 02:10:48','2026-03-09 02:10:48',3);
...
CREATE TABLE `videos` (
  ...
  CONSTRAINT `videos_website_id_foreign` FOREIGN KEY (`website_id`) REFERENCES `websites` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-03-09 16:20:11
